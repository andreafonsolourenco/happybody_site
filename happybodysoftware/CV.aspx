<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CV.aspx.cs" Inherits="CV" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    ...
    <script type="text/javascript">
        ...
        function deleteCV() {
            alertify.confirm('Remover CV', 'Tem a certeza que deseja remover o CV?', function () {
                $.ajax({
                    type: "POST",
                    url: "CV.aspx/deleteCV",
