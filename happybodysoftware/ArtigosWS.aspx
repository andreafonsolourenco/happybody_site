<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArtigosWS.aspx.cs" Inherits="ArtigosWS" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:120px; display:none;" id="divNew">
            ...
            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12' style='text-align:left; font-family: Noto Sans, sans-serif !important; height:100%'>
                ...
                <div class='col-lg-8 col-md-8 col-sm-8 col-xs-8'>
                    ...
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='text' class='form-control' id='dataNew' name='dataNew' placeholder='Data' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='text' class='form-control' id='autorNew' name='autorNew' placeholder='Autor' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function updateInfo() {
            ...
            $.ajax({
                type: "POST",
                url: "ArtigosWS.aspx/editar",
                data: '{"id_operador":"' + $('#lbloperatorid').html() + '", "id_artigo":"' + $('#lblidselected').html()
                    ...
                    + '", "imagem":"' + $('#selectImg').val() + '", "ordem":"' + $('#ordem').val()
                    + '", "data":"' + $('#data').val() + '", "autor":"' + $('#autor').val() + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
                    if (res.d != null) {
        ...
        function createService() {
            if ($('#designacaoNew').val().trim() == '') {
                alertify.message('É necessário definir um título para o artigo!');
                return;
            }

            if ($('#textoNew').val().trim() == '') {
                alertify.message('É necessário definir um texto para o artigo!');
                return;
            }

            if ($('#selectImgNew').val().trim() == '') {
                alertify.message('É necessário definir um nome de imagem para o artigo!');
                return;
            }
            ...
            if ($('#dataNew').val().trim() == '') {
                alertify.message('É necessário definir uma data para o artigo!');
                return;
            }

            if ($('#autorNew').val().trim() == '') {
                alertify.message('É necessário definir um autor para o artigo!');
                return;
            }
            ...
            $.ajax({
                type: "POST",
                url: "ArtigosWS.aspx/criar",
                data: '{"id_operador":"' + $('#lbloperatorid').html()
                    + '", "titulo":"' + titulo + '", "titulo_en":"' + titulo_en
                    + '", "titulo_es":"' + titulo_es + '", "titulo_fr":"' + titulo_fr
                    + '", "texto":"' + texto + '", "texto_en":"' + texto_en
                    + '", "texto_es":"' + texto_es + '", "texto_fr":"' + texto_fr
                    + '", "imagem":"' + $('#selectImgNew').val() + '", "ordem":"' + $('#ordemNew').val()
                    + '", "data":"' + $('#dataNew').val() + '", "autor":"' + $('#autorNew').val() + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
                    if (res.d != null) {
        ...
        function deleteService() {
            alertify.confirm('Remover Artigo', 'Tem a certeza que deseja remover o artigo?', function () {
                $.ajax({
                    type: "POST",
                    url: "ArtigosWS.aspx/DeleteArtigo",
        ...
        function changeImg() {
            $('#imgArtigo').attr("src", "img/loading.gif");
            $('#imgArtigo').attr("src", $('#pathToFiles').html() + $('#selectImg').val().trim());
        }

        function loadImagesSelect() {
            $.ajax({
                type: "POST",
                url: "ArtigosWS.aspx/loadImages",
