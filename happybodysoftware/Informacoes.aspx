<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Informacoes.aspx.cs" Inherits="Informacoes" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    <div style="width: 100%;" id="content">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
            <select class='form-control' id='data' style='width:100%; height: 40px; font-size: small;' onchange='load();'>
                <option value='0'>Sem Estado de Pagamento</option>
                <option value='1'>Não Pagos</option>
                <option value='2'>Débitos Diretos</option>
                <option value='3'>Pagamentos ao Balcão</option>
            </select>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
            ...
            <input type="image" src="img/icons/icon_search.png" onclick="load();" style="float:left; width:auto; height:50px; margin:auto; -moz-border-radius: 4px !important; -webkit-border-radius: 4px !important; border-radius: 4px !important;" />
    ...
    <script type="text/javascript">
        ...
        function load() {
            $.ajax({
                type: "POST",
                url: "Informacoes.aspx/load",
                data: '{"data":"' + $('#data').val() + '", "filtro":"' + $('#search').val() + '"}',
