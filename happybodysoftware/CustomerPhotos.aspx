<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerPhotos.aspx.cs" Inherits="CustomerPhotos" Culture="auto" UICulture="auto" %>
    ...
    <script type="text/javascript">
        ...
        function selectRow(nr_socio, x) {
            ...
            if ($('#lblnrsocioselected').html() == '') {
                ...
                if ($('#lblnrsocioselected').html() == nr_socio) {
                    $('#lblnrsocioselected').html('');
                    $('#photoName').val('');
                    $('#photoDiv').html('');
                    $('#photoDiv').height(150);
                }
