<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContactosWS.aspx.cs" Inherits="ContactosWS" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    <div style="width: 100%;" id="content">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:120px;" id="divTable" runat="server">
    ...
    <script type="text/javascript">
        ...
        function editInfo() {
            $.ajax({
                type: "POST",
                url: "ContactosWS.aspx/editar",
                data: '{"id_operador":"' + $('#lbloperatorid').html() + '", "morada":"' + $('#morada').val() + '", "fb":"' + $('#facebook').val()
                    + '", "instagram":"' + $('#instagram').val() + '", "email1":"' + $('#email1').val() + '", "email2":"' + $('#email2').val()
                    + '", "email3":"' + $('#email3').val() + '", "tlf1":"' + $('#tlf1').val() + '", "tlf2":"' + $('#tlf2').val() + '", "tlf3":"' + $('#tlf3').val()
                    + '", "email4":"' + $('#email4').val() + '", "whatsapp":"' + $('#whatsapp').val() + '", "youtube":"' + $('#youtube').val() + '", "linkedin":"' + $('#linkedin').val() + '"}',
