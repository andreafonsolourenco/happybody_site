...
public partial class Permissoes : Page
{
    string separador = "";
    string id = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!oCsm.IsStartupScriptRegistered(GetType(), "Permissoes"))
            {
    ...
    public static string loadPermissoes(string id_operador)
    {
        ...
        try
        {
            ...
            string sql = string.Format(@"   SET DATEFORMAT DMY;
                                            ...
                                            select 
                                                id_permissao as id, id_op, op, id_menu, menu, id_submenu, submenu, escrita, leitura
                                            from REPORT_PERMISSOES(@id_op, null, null)
                                            order by id_menu, id_submenu", id_operador);
    ...
    public static string alteraPermissao(string id_operador, string id_permissao, string escrita, string leitura)
    {
        ...
        try
        {
            ...
            string sql = string.Format(@"   SET DATEFORMAT DMY;
                                            ...
                                            EXEC ALTERA_PERMISSOES @id_operador, @id_permissao, @escrita, @leitura, @res output, @msg output
