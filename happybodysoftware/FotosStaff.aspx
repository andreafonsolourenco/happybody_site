<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FotosStaff.aspx.cs" Inherits="FotosStaff" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    <div style="width: 100%;" id="content">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id="divSocios" runat="server">
            <div style="width: 100%; margin-bottom: 10px;">
                ...
                <input type="image" src="img/icons/icon_search.png" onclick="loadStaff();" style="float:right; width:auto; height:50px; margin:auto; -moz-border-radius: 4px !important; -webkit-border-radius: 4px !important; border-radius: 4px !important;" />
            </div>
            <div style="width: 100%; margin-top: 10px !important;" id="table" runat="server">

            </div>
        </div>

        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div id="photoDiv" runat="server" style="width: 100%; height: 150px; text-align: center;">
    ...
    <script type="text/javascript">
        ...
        function selectRow(x) {
            ...
            if ($('#lblnrsocioselected').html() == '') {
                $('#ln_' + x.toString()).addClass('tbodyTrSelected');
                $('#photoName').val($('#codigo_' + x.toString()).html());
                $('#lblidselected').html($('#id_' + x.toString()).html());

                if ($.UrlExists('img/users/' + $('#codigo_' + x.toString()).html() + '.jpg')) {
                    var num = Math.random();
                    var imgSrc = $('#codigo_' + x.toString()).html() + ".jpg?v=" + num;
                    
                    $('#photoDiv').height(150);
                    $('#photoDiv').html('<img src="img/users/' + imgSrc + '" style="height: 150px !important; max-height: 150px !important; width: auto" />');
                }
                else {
                    $('#photoDiv').html('');
                    $('#photoDiv').height(150);
                ...
                if ($('#lblidselected').html() == $('#id_' + x.toString()).html()) {
                    $('#id_' + x.toString()).html('');
                    $('#photoName').val('');
                    $('#photoDiv').html('');
                    $('#photoDiv').height(150);
