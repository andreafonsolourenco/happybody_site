<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consentimentos.aspx.cs" Inherits="Consentimentos" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    <div style="width: 100%;" id="content">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="divBtns" runat="server" style="margin-bottom: 25px;">
            <input type="button" class="form-control" value="Exportar" style="width: 100%; float: right; margin: auto; height: 40px; font-size: small" onclick="exportExcel();" />
        </div>
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            $('#tableGrid').btechco_excelexport({
               ...
               , filename: 'exportacao_listagem_consentimentos'
            });
        }
    </script>
</body>
