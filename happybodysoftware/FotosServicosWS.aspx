<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FotosServicosWS.aspx.cs" Inherits="FotosServicosWS" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    <div style="width: 100%;" id="content">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <form id="formUploadPhoto" runat="server">
                <asp:TextBox ID="ServiceID" runat="server" CssClass="form-control variaveis" ClientIDMode="Static" />
    ...
    <script type="text/javascript">
        ...
        function selectRow(serviceid, x) {
            var i = 0;
            var img = "";
            ...
            if ($('#ServiceID').val() == '') {
                img = $('#img_' + x.toString()).html();
                $('#ln_' + x.toString()).addClass('tbodyTrSelected');
                $('#ServiceID').val(serviceid);

                if ($.UrlExists(img))
                    $('#photoDiv').html('<img src="' + img + '" style="height: 100%; width: auto" />');
                else {
