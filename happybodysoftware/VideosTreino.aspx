<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VideosTreino.aspx.cs" Inherits="VideosTreino" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    <div style="width: 100%;" id="content">
        ...
        <form id="formUploadVideo" runat="server">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="divTable">
                ...
                <asp:Button runat="server" id="UploadButton" text="Carregar Video" onclick="UploadButton_Click" CssClass="form-control"/>
                <br />
