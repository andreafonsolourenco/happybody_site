<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Permissoes.aspx.cs" Inherits="Permissoes" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    ...
    <script type="text/javascript">
        ...
        function load() {
            $.ajax({
                type: "POST",
                url: "Permissoes.aspx/loadPermissoes",
        ...
        function mudaPermissao(id_permissao, x) {
            ...
            $.ajax({
                type: "POST",
                url: "Permissoes.aspx/alteraPermissao",
