...
<body style="background-color: #FFF !important">
    <div style="width: 100%;" id="content">
        ...
        <span class="variaveis" id="lbladmin" runat="server"></span>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="divTable">
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="margin-bottom: 10px;">
                ...
                <input type="image" src="img/icons/icon_search.png" onclick="loadOperators();" style="float:right; width:auto; height:50px; margin:auto;" />
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="margin-bottom: 10px;">
                <input id="btnNewOperator" type="button" value="Novo Operador" onclick="openNewOperator();" style="float: right; background-color: #4282b5; width: 80%; height: 50px; font-size: 12pt; text-align: center; line-height: 50px; color: #FFFFFF; cursor: pointer; vertical-align: middle; border: none; padding: 0 5px; -moz-border-radius: 2px; -webkit-border-radius: 2px; border-radius: 2px;" runat="server"/>
            </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:120px; display:none;" id="divNew">
            <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6' style='text-align:left; margin-top: 5px; margin-bottom: 10px;'>
                <input id='btnSave' value='Guardar' runat='server' type='button' onclick='createOperator();' style='background-color: #4282b5; 
            ...
            <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6' style='text-align:right; margin-top: 5px; margin-bottom: 10px;'>
                <img src='img/icons/icon_close.png' style='cursor:pointer;' onclick='closeNewOperator();'/>
            </div>
            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12' style='text-align:left; font-family: "Noto Sans", sans-serif !important; height:100%'>
                <div class='col-lg-4 col-md-4 col-sm-4 col-xs-4'>
                    ...
                    <div style='height:50px; width:100%; margin-bottom: 10px'>Administrador:</div>
                ...
                <div class='col-lg-8 col-md-8 col-sm-8 col-xs-8'>
                    ...
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='text' class='form-control' id='emailNew' name='emailNew' placeholder='Email' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='password' class='form-control' id='passwordNew' name='passwordNew' placeholder='Password' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='text' class='form-control' id='telefoneNew' name='telefoneNew' placeholder='Telefone' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='text' class='form-control' id='telemovelNew' name='telemovelNew' placeholder='Telemóvel' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='checkbox' class='form-control' id='administradorNew' name='administradorNew' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='checkbox' class='form-control' id='escritaNew' name='escritaNew' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='checkbox' class='form-control' id='leituraNew' name='leituraNew' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='checkbox' class='form-control' id='ativoNew' name='ativoNew' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
                    <div style='height:50px; width:100%; margin-bottom: 10px'>
                        <input type='checkbox' class='form-control' id='visivelNew' name='visivelNew' style='width: 100%; margin: auto; height: 100%;'/>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function loadOperators() {
            $.ajax({
                type: "POST",
                url: "Staff.aspx/load",
                data: '{"filtro":"' + $('#search').val() + '", "administrador":"' + $('#lbladmin').html() + '"}',
        ...
        function openOperatorInfo(id, x) {
            $('#lblidselected').html(id);

            $.ajax({
                type: "POST",
                url: "Staff.aspx/getOperatorData",
                data: '{"id":"' + id + '", "meuID":"' + $('#lbloperatorid').html() + '", "administrador":"' + $('#lbladmin').html() + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
                    if (res.d != null) {
        ...
        function updateInfo() {
            alertify.confirm('Staff', 'Tem a certeza que deseja atualizar a informação relativa ao Operador?',
                function () {
                    var administrador = "";
                    var escrita = "";
                    var leitura = "";
                    ...
                    if ($('#nome').val().trim() == "") {
                        alertify.message('É necessário inserir nome!');
                        return;
                    }

                    if ($('#codigo').val().trim() == "") {
                        alertify.message('É necessário inserir código!');
                        return;
                    }

                    if ($('#email').val().trim() == "") {
                        alertify.message('É necessário inserir email!');
                        return;
                    }

                    if ($('#password').val().trim() == "") {
                        alertify.message('É necessário inserir password!');
                        return;
                    }

                    $.ajax({
                        type: "POST",
                        url: "Staff.aspx/editar",
                        data: '{"id_operador":"' + $('#lbloperatorid').html() + '", "id_op":"' + $('#lblidselected').html() + '", "codigo":"' + $('#codigo').val()
                            + '", "nome":"' + $('#nome').val() + '", "email":"' + $('#email').val() + '", "password":"' + $('#password').val()
                            + '", "notas":"' + $('#notas').val() + '", "telefone":"' + $('#telefone').val() + '", "telemovel":"' + $('#telemovel').val()
                            + '", "administrador":"' + administrador + '", "escrita":"' + escrita + '", "leitura":"' + leitura + '", "ativo":"' + ativo + '", "visivel":"' + visivel + '"}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (res) {
                            if (res.d != null) {
                                ...
                                if (res.d.indexOf('Erro') > -1)
                                    ...
                                    registaLog($('#lbloperatorid').html(), 'STAFF', 'Atualizada informação relativa ao operador ' + $("#codigo").val());
        ...
        function createOperator() {
            alertify.confirm('Staff', 'Tem a certeza que deseja criar um novo Operador?',
                function () {
                    var administrador;
                    var escrita;
                    var leitura;
                    ...
                    if ($('#escritaNew').is(':checked'))
                        escrita = "1";
                    else
                        escrita = "0";

                    if ($('#leituraNew').is(':checked'))
                        leitura = "1";
                    else
                        leitura = "0";
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Staff.aspx/criar",
                        data: '{"id_operador":"' + $('#lbloperatorid').html() + '", "codigo":"' + $('#codigoNew').val()
                            + '", "nome":"' + $('#nomeNew').val() + '", "email":"' + $('#emailNew').val() + '", "password":"' + $('#passwordNew').val()
                            + '", "notas":"' + $('#notasNew').val() + '", "telefone":"' + $('#telefoneNew').val() + '", "telemovel":"' + $('#telemovelNew').val()
                            + '", "administrador":"' + administrador + '", "escrita":"' + escrita + '", "leitura":"' + leitura + '", "ativo":"' + ativo + '", "visivel":"' + visivel + '"}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (res) {
                            if (res.d != null) {
                                if (res.d.indexOf('Erro') > -1)
                                    ...
                                    closeNewOperator();
                                    loadOperators();
                                    registaLog($('#lbloperatorid').html(), 'STAFF', 'Criado operador ' + $("#codigoNew").val());
                                    $('#codigoNew').val('');
                                    $('#nomeNew').val('');
                                    $('#emailNew').val('');
                                    $('#passwordNew').val('');
                                    ...
                                    $('#telefoneNew').val('');
                                    $('#telemovelNew').val('');
                                    $('#administradorNew').attr('checked', false);
                                    $('#escritaNew').attr('checked', false);
                                    $('#leituraNew').attr('checked', false);
                                    $('#ativoNew').attr('checked', false);
                                    $('#visivelNew').attr('checked', false);
                                }
                            }
                        }
                    });
        ...
        function closeNewOperator() {
            $('#divTable').fadeIn();
            $('#divNew').fadeOut();
        }

        function deleteOperator() {
            alertify.confirm('Staff', 'Tem a certeza que deseja remover o Operador?',
                function () {
                    $.ajax({
                        type: "POST",
                        url: "Staff.aspx/apagar",
                        data: '{"id_operador":"' + $('#lbloperatorid').html() + '", "id_op":"' + $('#lblidselected').html() + '"}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (res) {
                            if (res.d != null) {
                                $('#search').val('');
                                registaLog($('#lbloperatorid').html(), 'STAFF', 'Eliminação do operador ' + $("#codigo").val());
                                closeOperatorInfo();
                                alertify.message(res.d);
                                loadOperators();
                            }
