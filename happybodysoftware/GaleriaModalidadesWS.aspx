<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GaleriaModalidadesWS.aspx.cs" Inherits="GaleriaModalidadesWS" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    ...
    <script type="text/javascript">
        ...
        function changeImg() {
            ...
            $.ajax({
                type: "POST",
                url: "GaleriaModalidadesWS.aspx/load",
        ...
        function updateGaleria(xml) {
            $.ajax({
                type: "POST",
                url: "GaleriaModalidadesWS.aspx/updateGaleria",
