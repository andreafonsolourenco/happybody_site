...
public partial class GaleriaModalidadesWS : Page
{
    string separador = "";
    string id = "";
    ...
    private void loadImg1()
    {
        ...
        try
        {
            ...
            string sql = string.Format(@"select CONCAT(SITE, MODALIDADES) AS PATH from report_paths()");
            ...
            table.AppendFormat(@"<option value='0'>Selecione uma imagem/video</option>");
        ...
        try
        {
            ...
            string sql = string.Format(@"   DECLARE @nome varchar(500) = '{0}';
                                            ...
                                            SELECT 
	                                            ...
	                                            ordem,
	                                            presente
                                            FROM REPORT_GALERIA_MODALIDADES(@nome)
                                            ORDER BY modalidade asc", ficheiro);
            ...
            if (myReader.HasRows)
            {
                ...
                while (myReader.Read())
                {
                    ...
                    table.AppendFormat(@"<tr>
                                            <td style='display:none' id='id_modalidade_{3}'>{4}</td>
                                            <td>{0}</td>
    ...
    public static string updateGaleria(string id_operador, string xml)
    {
        ...
        try
        {
            ...
            string sql = string.Format(@"   DECLARE @id_op int = {0};
                                            ...
                                            EXEC UPDATE_GALERIA_MODALIDADES @id_op, @xml, @ret output
