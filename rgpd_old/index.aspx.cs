...
public partial class index : Page
{
    ...
    public static string sendEmailFromTemplate(string nome, string email, string telefone, string autorizo, string treinooferecidopor)
    {
        try
        {
            ...
            string intro = "CONSENTIMENTO DO TITULAR DE DADOS INFORMADO";
            string body = "Nos termos do RGPD, consinto que os meus dados pessoais (nome, email e telefone ou telemóvel) sejam utilizados para:<br />"
                ...
                + "Nome: " + nome + "<br />"
                + "Treino Oferecido Por: " + treinooferecidopor + "<br />"
                + "Email: " + email + "<br />"
