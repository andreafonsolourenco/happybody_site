...
public partial class index : Page
{
    ...
    private void getPage()
    {
        ...
        string titulo = "", enviar = "", rgpd = "", nome = "", marcartreino = "", treinooferecidopor = "", email = "", tlm = "", consentimento = "";
        ...
        try
        {
            string sql = string.Format(@"   DECLARE @titulo varchar(max);
                                            ...
                                            DECLARE @treinoferecidopor varchar(max);
                                            ...
                                            set @traducao = 'Treino Oferecido Por'
                                            EXEC DEVOLVE_TRADUCAO @traducao, @lingua, @treinoferecidopor output;
                                            ...
                                            SELECT 
                                                ...
                                                @treinoferecidopor as treinoferecidopor,
                                                @email as email,
                                                @tlm as tlm,
            ...
            if (oDs.Tables != null && oDs.Tables.Count > 0 && oDs.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < oDs.Tables[count].Rows.Count; i++)
                {
                    ...
                    treinooferecidopor = oDs.Tables[count].Rows[i]["treinoferecidopor"].ToString();
        ...
        table.AppendFormat(@"   <div class='row'>
                                ...
                                <div class='row' style='font-weight: bold; margin-bottom: 15px;'>
                                    ...
                                    <div class='col-lg-9 col-md-9 col-xs-9 col-sm-9' style='text-align: left !important;'>
                                        <div class='form-group' style='text-align: left !Important;'>
                                            <label class='form-control-label' for='autorizacao'>{7}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class='row' style='font-weight: bold; margin-bottom: 15px;'>
                                ...
                                <div class='row' style='font-weight: bold; margin-bottom: 15px;'>
                                    <div class='col-lg-6 col-md-6 col-xs-6 col-sm-6'>
                                        <div class='form-group'>
                                            <label class='form-control-label' for='email' id='emaillabel'>{5}</label>
                                            <input type='email' id='email' class='form-control form-control-alternative' placeholder='{5}'>
                                        </div>
                                    </div>
                                    <div class='col-lg-6 col-md-6 col-xs-6 col-sm-6'>
                                        <div class='form-group'>
                                            <label class='form-control-label' for='tlf' id='tlflabel'>{6}</label>
                                            <input type='tel' id='tlf' class='form-control form-control-alternative' placeholder='{6}'>
                                        </div>
                                    </div>
                                </div>
                                <div class='row' style='font-weight: bold; margin-bottom: 20px;'>
                                    <div class='col-lg-12 col-md-12 col-xs-12 col-sm-12 col-12'>
                                        <div class='form-group'>
                                            <label class='form-control-label' for='treinooferecidopor' id='treinooferecidoporlabel'>{4}</label>
                                            <input type='text' id='treinooferecidopor' class='form-control form-control-alternative' placeholder='{4}'>
                                        </div>
                                    </div>
                                </div>", titulo, rgpd, nome, marcartreino, treinooferecidopor, email, tlm, consentimento);
    ...
    [WebMethod]
    public static string saveRGPDConsent(string nome, string email, string telefone, string autorizo, string treinooferecidopor)
    {
        try
        {
            var table = new StringBuilder();
