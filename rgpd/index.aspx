...
<body style="background-color: #FFF !important">
    <div style="width: 100%; height: 100%" id="content">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contentCenter" id="textContent" runat="server" style="padding-top: 10px;"></div>
    ...
    <script type="text/javascript">
        ...
        function sendRGPDEmail() {
            ...
            if (treinooferecidopor == '' || treinooferecidopor.length == 0 || treinooferecidopor == null || treinooferecidopor == undefined) {
                error = error.replace('[FIELD]', $('#treinooferecidoporlabel').html());
                alertify.error(error);
                return;
            }
            ...
            $.ajax({
                type: "POST",
                url: "index.aspx/saveRGPDConsent",
                ...
                success: function (res) {
                    if (res.d != null) {
                        if (res.d == '0') {
                            $.ajax({
                                type: "POST",
                                url: "../happybody/emails.aspx/sendRGPDEmail",
                                data: '{"name":"' + nome + '", "email":"' + email + '", "tlf":"' + tlf + '", "treinooferecidopor":"' + treinooferecidopor + '", "language":"' + language + '"}',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (res) {
                                    if (res.d != null) {
