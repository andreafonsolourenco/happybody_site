...
public partial class index : Page
{
    ...
    public static string sendEmailFromTemplate(string nome, string email, string telefone, string autorizo, string treinooferecidopor)
    {
        try
        {
            ...
            newsletterText = File.ReadAllText(HttpContext.Current.Server.MapPath("~") + "\\campaign//templates//rgpd.html");
            ...
            string body = "<img src='https://happybody.site/campanhas/img/gymsummer.jpg' style='width:100%; height:auto;' />Nos termos do RGPD, consinto que os meus dados pessoais (nome, email e telefone ou telemóvel) sejam utilizados para receber informação acerca da Campanha Gym Summer Pack.<br />"
                + "Nome: " + nome + "<br />"
                + "Email: " + email + "<br />"
