<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index_old.aspx.cs" Inherits="index_old" Culture="auto" UICulture="auto" %>
...
<body style="background-color: #FFF !important">
    <div style="width: 100%; height: 100%" id="content">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contentCenter" id="textContent" runat="server">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 photoDiv" style="text-align: center;">
                <img src="img/landing_photo.jpg" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 nopadding">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 nopadding">Data e Hora de Contacto:</div>
                <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 nopadding">
            ...
            <div class="titleDiv">CONSENTIMENTO DO TITULAR DE DADOS INFORMADO</div>
            <span class="text">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 nopadding" style="font-weight: bold;">
                <div class="checkbox nopadding" style="font-weight: bold; font-size: small;">
                    <label>
                        <input type="checkbox" id="autorizacao" />
                        Fui informado dos meus direitos de acesso, retificação, oposição e esquecimento. A conservação dos dados será efetuada desde a presente data até indicação do contrário via email para happybodyfitcoach@gmail.com<br /><br />
                    </label>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 googleMap" id="googleMap">
                <iframe id='frameMap' src='https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12186.293145356607!2d-8.416715!3d40.218554!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x31e678dad25d53fa!2sGin%C3%A1sio+Happy+Body!5e0!3m2!1spt-PT!2spt!4v1498609129615' height='400' frameborder='0' style='border:0' allowfullscreen></iframe>
            </div>
        </div>

        <div class="footer">
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 nopadding footerDiv">
                <input type="button" class='form-control' value="Enviar" onclick="checkValues();" />
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#data').datepicker({ format: 'dd/mm/yyyy', changeYear: true, changeMonth: true, orientation: 'auto top' });

            $('#frameMap').width($('#googleMap').width());
        });
        ...
        function sendEmail(nome, email, telefone, autorizo, datahora) {
            $.ajax({
                type: "POST",
        ...
        function checkValues() {
            ...
            if (data == '') {
                alertify.message('Por favor, preencha a data de contacto antes de enviar o consentimento! Obrigado.');
                return;
            }

            if (hora == '') {
                alertify.message('Por favor, preencha a hora de contacto antes de enviar o consentimento! Obrigado.');
                return;
            }
            ...
            alertify.confirm('Consetimento do titular de dados informado', 'Tem a certeza que deseja enviar a declaração de consentimento?',
                function () {
                    sendEmail(nome, email, tlf, autorizacao, datahora);
                },
